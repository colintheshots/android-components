...
class Main {
  ...
  async sendError(msg) {
    log(msg)
    port.postMessage({type: "sendError", error: msg});
  }

  async authFailure(data) {
    switch (data) {
      case FXA_ERR_AUTH:
        await this.sendError("authentication failed")
      ...
      case FXA_ERR_GEO:
        await this.sendError("authentication failed because of geo restrictions")
      ...
      case FXA_ERR_NETWORK:
        ...
        await this.sendError("authentication failed by network - ignore")
        break;
